...
**variable** : une caractéristique étudiée par la question de recherche (âge,
...
> - qualitatives : représentées par un attribut ou une classe (ville de naissance) 

Ce document ne traite que des statistiques des variables quantitatives.
